 ...
 */
export const parseMarkdownToRAG = (content, metadata) => {
...
export class DocumentCollectionManager {
     ...
     */
    calculateRelevance(doc, queryTokens) {
        let score = 0;
 ...
 */
export const createCollectionManager = (name, basePath) => {
