...
function generateZodSchemaCode(model: string, fields: Record<string, string>): string {
...
function generateTrpcRouterCode(model: string, operations: string[]): string {
...
async function runVerification(
  checks: string[],
  pkg?: string
): Promise<{ passed: boolean; results: Record<string, { passed: boolean; output: string }> }> {
