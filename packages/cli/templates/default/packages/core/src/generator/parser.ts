 ...
 */
export const normalizeField = (field: string | FieldDefinition): FieldDefinition => {
 ...
 */
export const getNormalizedFields = (schema: JapavelSchema): Record<string, FieldDefinition> => {
